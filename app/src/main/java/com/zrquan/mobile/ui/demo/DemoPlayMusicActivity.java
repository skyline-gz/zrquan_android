...
import com.zrquan.mobile.support.player.SeekBarPlayer;
import com.zrquan.mobile.widget.download.DownloadProgressListener;
import com.zrquan.mobile.widget.download.FileDownloader;

import java.io.File;
import java.io.UnsupportedEncodingException;
import java.net.URLEncoder;

//from http://blog.csdn.net/wwj_748/article/details/20933055
public class DemoPlayMusicActivity extends Activity {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case PROCESSING: // 更新进度
                    ...
                    break;
                case FAILURE: // 下载失败
                    Toast.makeText(getApplicationContext(), "下载出错",
                            Toast.LENGTH_LONG).show();
                    break;
            }
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_demo_play_music);
        ...
        player = new SeekBarPlayer(musicProgress);
    ...
    private final class ButtonClickListener implements View.OnClickListener {
        ...
        private final class DownloadTask implements Runnable {
            ...
            public void run() {
                try {
                    // 实例化一个文件下载器
                    loader = new FileDownloader(ZrquanApplication.getInstance().getDatabaseHelper()
                            , path, saveDir, 3);
                    // 设置进度条最大值
