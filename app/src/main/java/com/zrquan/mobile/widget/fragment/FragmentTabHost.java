/*
 * Copyright (C) 2015 vicky fan yuqi.fan@foxmail.com
...
//从support v4 copy 过来的，可以为tabhost添加无fragment的类

package com.zrquan.mobile.widget.fragment;
...
public class FragmentTabHost extends TabHost
    ...
    private FragmentTransaction doTabChanged(String tabId, FragmentTransaction ft) {
        ...
        if (mLastTab != newTab) {
            boolean bIsEmptyNewTab = (newTab.fragment == null && newTab.clss == null);
            if (ft == null) {
                ft = mFragmentManager.beginTransaction();
            }
            if (mLastTab != null) {
                if (mLastTab.fragment != null && !bIsEmptyNewTab) {
                    ft.detach(mLastTab.fragment);
                }
                if (mFragmentShowInEmptyTab != null) {
                    ft.detach(mFragmentShowInEmptyTab);
                    mFragmentShowInEmptyTab = null;
                }
            }
            if (newTab != null && !bIsEmptyNewTab) {
            ...
            if(bIsEmptyNewTab) {
                if(mLastTab != null) {
                    mFragmentShowInEmptyTab = mLastTab.fragment;
                }
            }
