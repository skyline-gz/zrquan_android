...
package com.zrquan.mobile.support.sharedpreferences;
...
public class SPManager {
    ...
    public SPManager(Context appContext) {
        mContext = appContext;
     ...
     * <p/>
     *
     * @param theFolder String - the folder path dir you want to save it to e.g
     *               "DropBox/WorkImages"
     * @param theImageName String - the name you want to assign to the image file e.g
     *               "MeAtlunch.png"
     */
